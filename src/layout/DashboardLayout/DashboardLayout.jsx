            ...
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-content flex flex-col-reverse lg:flex-col ">
                    ...
                    <div className="flex md:justify-center">
                        <label htmlFor="my-drawer-3" className="text-white bg-[#007BFE] py-3 px-6 rounded-xl font-semibold  drawer-button lg:hidden md:w-52 w-36 text-lg mb-20 md:ml-0 ml-3 text-center">Show All Resources</label>
                    </div>
                </div>
