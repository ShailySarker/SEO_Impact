        ...
        <div className="my-12">
            ...
            <div className="ml-40 grid grid-cols-2 items-center">
                <div className="pl-24">
                    ...
                    <h3 className="font-bold text-3xl pt-2">success with <br />our SEO tools.</h3>
                    <p className="pt-10 text-2xl font-semibold text-slate-500">Don’t wait just buy <br />the plan and enjoy <br />your success</p>
                </div>
