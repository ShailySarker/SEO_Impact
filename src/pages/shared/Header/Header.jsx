              ...
              lg:px-10 px-2 py-6 mb-8 md:px-24">
                <div className="navbar-start">
                    ...
                    justify-center items-center lg:ml-0">
                        <img className="lg:border-r-2 lg:pr-24" src='https://i.ibb.co/LgjTcLv/Group-157.png' alt="" />
                    </div>
                </div>
                        ...
                        <div className="drawer drawer-end">
                            ...
                            <div className="drawer-side">
                                ...
                                <ul className="menu py-6 px-4 md:px-6 md:mt-20 mt-16 w-40 md:w-52 rounded-l-lg bg-base-200 text-base-content">
                                    ...
                                    <NavMenu></NavMenu>
                                    {/* <li><Link to='/signUp' className=" rounded-3xl bg-[#0030FF] text-white font-bold">Sign Up</Link></li> */}
                                    <li>
