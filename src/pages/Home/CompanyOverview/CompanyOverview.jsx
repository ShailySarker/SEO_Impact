        ...
        <div className="my-28 flex px-20 justify-center gap-28">
            <div className="">
                <div className="">
                    ...
                    <img className="rounded-full p-5 w-20 bg-[#F92F60] relative bottom-[270px] left-52" src="https://i.ibb.co/8j5GPZ3/Vector-1.png" alt="" />
                </div>
            ...
            <div className="">
                <div className="">
                    ...
                    <img className="rounded-full p-5 w-20 bg-[#FF5C00] relative bottom-[270px] left-52" src="https://i.ibb.co/P1hQ504/Vector-2.png" alt="" />
                </div>
                <div className="flex text-center flex-col">
            ...
            <div className="">
                <div className="">
                    ...
                    <img className="rounded-full p-5 w-20 bg-[#007BFE] relative bottom-[270px] left-52" src="https://i.ibb.co/8j5GPZ3/Vector-1.png" alt="" />
                </div>
                <div className="flex text-center flex-col">
