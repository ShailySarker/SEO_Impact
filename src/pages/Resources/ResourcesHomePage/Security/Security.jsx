...
const Security = () => {
    return (
        <div className="mt-28">
            <h2 className="font-bold md:text-5xl text-3xl mb-12">Security</h2>
            ...
            <div className="mt-28 grid md:grid-cols-2 grid-cols-1 gap-16 md:mx-0 mx-4">
                ...
                <div className="">
                    ...
                    <div className="border-2 px-5 py-10 shadow-xl h-[550px]">
                        <h3 className="font-semibold text-center md:text-3xl text-xl">HTTPS SECURED</h3>
                        <div className="flex justify-center my-16">
                            <StarRight></StarRight>
                        </div>
                        <div className="text-center">
                            <h3 className="font-bold md:text-2xl text-lg pb-8">Hurray it is secured!</h3>
                ...
                <div className="">
                    <FailBox></FailBox>
                    <div className="border-2 px-5 py-10 shadow-xl h-[550px]">
                        <h3 className="font-semibold text-center md:text-3xl text-xl">Secure JS Libraries</h3>
                        <div className="flex justify-center my-16">
                            <StarClose></StarClose>
                        </div>
                        <div className="text-center">
                            <h3 className="font-bold md:text-2xl text-lg pb-8">Am not feeling safe here!</h3>
