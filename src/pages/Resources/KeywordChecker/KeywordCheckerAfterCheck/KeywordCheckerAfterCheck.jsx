    ...
    return (
        <div className="mt-12 ml-16">
            ...
            <div className="mt-24 flex flex-col items-center gap-10">
                <input className="border-2 py-3 px-7 w-96 rounded-lg" type="search" name="" id="" placeholder="Google" />
                <input className="border-2 py-3 px-7 w-96 rounded-lg" type="search" name="" id="" placeholder="www.google.co.in" />
