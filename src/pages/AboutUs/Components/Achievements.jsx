import trophy from '../../../assets/images/AboutUs/Achievements/trophy.png';
        ...
        <div className="lg:pt-16 md:pt-12 pt-10 lg:mb-40 md:mb-28 mb-24 md:mx-16 mx-6">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:mx-0 md:mx-12 mx-5 md:gap-10 gap-6 mt-20">
                <div className="border-4 border-[#007BFE] rounded-xl lg:px-6 md:px-8 px-4 py-8 flex flex-col bg-[#EBF5FF]">
                    <img className='w-52 h-5w-52 mx-auto mt-5' src={trophy} alt="trophy image" />
                    <h2 className="text-[#007BFE] font-bold lg:text-3xl text-xl text-center pb-5 pt-14">International Awards </h2>
                    <h2 className="lg:text-2xl text-xl font-semibold text-center pb-4 text-black">As best SEO suite software</h2>
                </div>
                <div className="border-4 border-[#007BFE] rounded-xl lg:px-6 md:px-8 px-4 py-8 flex flex-col bg-[#EBF5FF]">
                    <img className='w-52 h-5w-52 mx-auto mt-5' src={trophy} alt="trophy image" />
                    <h2 className="text-[#007BFE] font-bold lg:text-3xl text-xl text-center pb-5 pt-14">International Awards </h2>
